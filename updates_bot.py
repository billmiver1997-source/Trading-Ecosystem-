...
schedule.every().day.at("09:00").do(daily_tip)
schedule.every().monday.at("08:00").do(weekly_preview)
schedule.every().friday.at("20:00").do(weekly_summary)
schedule.every().sunday.at("18:00").do(psychology_post)
